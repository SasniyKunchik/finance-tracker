...
public class RestClientProductsRestClientImpl implements ProductsRestClient {
    // чтобы при парсинге json обьекта библиотекой jackson java понимала что это за обьект
    ...
    public Optional<Product> findProduct(int productId) {
        try {
            ...
            return Optional.ofNullable(this.restClient.get()
                    .uri("/catalogue-api/products/{productId}", productId).retrieve().body(Product.class));
